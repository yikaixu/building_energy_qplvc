...
if __name__ == "__main__":
    ...
    quantile_level_grid_qplvc = [0.9] # use this for Figure 7
    ...
    for energy_type in ['W']:
        ...
        # -- Evaluation: QS
            ...
            # get_vary_coef_plot(list_vstack(t_train), visualize_beta, visualize_knot, vary_cov, energy_type, visualize_q, ['Area', 'Stair1', 'Stair2'], visualize_nl_predictors)
            ...
            get_shap_plot(qgb_best, x_train, energy_type, visualize_q, ['Area', 'Stair1', 'Stair2'], vary_cov, cur_mean_std)
